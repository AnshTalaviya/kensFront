    ...
    return (
        <div className="min-h-screen bg-black text-white  pb-10">
            ...
            <div className="max-w-6xl mx-auto px-4">
                {/* Categories slider section (commented out) */}
                {/*
                <div className="flex justify-between items-center mb-6 flex-wrap">
                    <div>
                        <div className="text-2xl font-semibold">Explore our wide variety of categories</div>
                    ...
                    <div className="bg-black p-2 rounded-lg hidden md:block">
                        <div className="flex items-center gap-2">
                            <button className="btn btn-dark py-2" onClick={() => sliderRef.current.slickPrev()}>
                                <ArrowBackIcon />
                            </button>
                            <div className="flex gap-1">
                                {[...Array(totalGroups)].map((_, i) => (
                                    <div
                                        key={i}
                                        className={`slide_dot ${currentGroup === i ? 'active_dot' : ''}`}
                                    ></div>
                                ))}
                            </div>
                            <button className="btn btn-dark py-2" onClick={() => sliderRef.current.slickNext()}>
                                <ArrowForwardIcon />
                            </button>
                        </div>
                    </div>
                ...
                <Slider ref={sliderRef} {...settings}>
                    {categoryData.map((category, index) => (
                        <Link to={`/movies/${category.title}`} key={index}>
                            <div className="p-2">
                                <div className="bg-black text-white rounded-xl overflow-hidden p-4">
                                    <div className="text-center">
                                        <img className="mx-auto" src={category.img} alt={category.title} />
                                    </div>
